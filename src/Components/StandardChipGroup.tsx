import React, { forwardRef, Fragment, MouseEventHandler, useMemo } from "react";
...
const StandardChipGroup = forwardRef(
  (props: { field: StandardChipGroupProps; showTitle: boolean }, ref) => {
    const {
      control,
      getValues,
      setValue,
