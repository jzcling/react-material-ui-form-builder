...
| labelProps          | `object` | `undefined`                                                                                                                                                        | Only for `chip-group`, `checkbox-group`, `radio-group` and `switch`. Any additional props to pass to the Material UI Typography (`chip-group`, `checkbox-group`, `radio-group`) or FormControlLabel (`switch`) component that wraps the label. |
