...
| component           | `string`            | `text-field`                                                                                                                                                                                   | One of: <br />`text-field`,<br />`select`,<br />`date-picker`,<br />`date-time-picker`,<br />`time-picker`,<br />`autocomplete`,<br />`chip-group`,<br />`checkbox-group`,<br />`radio-group`,<br />`switch`,<br />`file-upload`,<br />`image-picker`,<br />`display-text`,<br />`display-image`,<br />`display-media`,<br />`rich-text`<br />`custom` |
...
| images              | `array`             | `undefined`                                                                                                                                                                                    | Only for `image-picker`. This should contain an array of objects with attributes `src` and `alt`                                                                                                                                                                                                                                                       |
| imageCols           | `number`            | `2`                                                                                                                                                                                            | Only for `image-picker`. Number of columns in image list                                                                                                                                                                                                                                                                                               |
